...
> **Статус:** черновик для совместного review и спора.
>
> **Дата:** 2026-08-09
>
...
>
> **Это не implementation plan.** После комментариев владельца проекта документ будет пересмотрен, спорные решения будут зафиксированы, и только затем появятся отдельные технические планы.
