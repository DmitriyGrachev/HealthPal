...
Add `src/main/resources/db/migration/V35__create_knowledge_claims.sql` with:
...
Add `src/main/resources/db/migration/V36__create_knowledge_claim_usage_and_conflicts.sql` with:
...
Add `src/main/resources/db/migration/V37__version_memory_projection.sql` with:
