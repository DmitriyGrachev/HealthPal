...
/** PostgreSQL adapter for owner-bound, monotonic nutrition day state. */
@Component
public class NutritionSourceStatePersistenceAdapter
        implements NutritionSourceStatePort, NutritionSourceStateQueryPort {
    ...
    public NutritionSourceStatePersistenceAdapter(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
