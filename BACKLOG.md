...
- [x] [FIX-012] Восстановить HNSW index для `user_memory.embedding`
- [x] [FIX-013] Синхронизировать pgvector table/dimension config
...
- [x] [FIX-020] Добавить CI baseline
...
- [x] [FIX-029] Сделать workout `@ManyToOne` lazy
- [x] [FIX-030] Вынести AI prompts в versioned resources
